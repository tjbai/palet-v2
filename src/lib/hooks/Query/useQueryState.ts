...
https://github.com/47ng/next-usequerystate/blob/87a50fdd7c69e571d9e3a68deb2e74c39c35261d/src/useQueryState.ts
*/
...
export function useQueryState<T = string>(
  ...
  const getOldValue = useCallback((): T | null => getValue("previous"), []);
